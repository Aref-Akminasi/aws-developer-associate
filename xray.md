...
1. Your code must import the AWS X-Ray SDK (requires little code modifications)
2. Install the X-Ray Daemon on the instance running the application
...
### X-Ray with Applications on-premises
